package com.unical.papersplease;
...
@ComponentScan({"com.unical.papersplease"})
public class PaperspleaseApplication {

	public static void main(String[] args) {
		SpringApplication.run(PaperspleaseApplication.class, args);
	}
